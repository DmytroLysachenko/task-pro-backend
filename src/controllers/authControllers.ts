...
const resendVerifyMessage: Controller = async (req, res) => {
  ...
  const data = {
    ...
    subject: 'Confirm your registration in TaskPro app',
    text: 'Press on the link to confirm your email',
    html: `Good day! Please click on the following link to confirm your account in TaskPro app. <a href="${BASE_URL}/users/verify/${verificationToken}" target="_blank" rel="noopener noreferrer">Confirm my mail</a>`,
  };
